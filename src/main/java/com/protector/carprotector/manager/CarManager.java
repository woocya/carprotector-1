...
public class CarManager {
    ...
    public void fillDB() {
        save(new Car(1L, "Toyota CHR", 2020, "Hybrid", "EL-345WR", LocalDate.of(2020,01,01), new Limitations(LocalTime.parse("09:00:00"), LocalTime.parse("23:00:00"), new Coordinates(51.65, "N", 19.4, "E"), new Coordinates(51.9, "N", 19.6, "E"), false)));
    }
}
